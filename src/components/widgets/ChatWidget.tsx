...
const INITIAL_MESSAGE: ChatMessage = {
  role: "assistant",
  content:
    "Olá! 👋 Sou o assistente virtual da C&Q Finanças. Posso ajudar a esclarecer dúvidas sobre crédito habitação, transferência de crédito, crédito pessoal, IMT, Imposto do Selo, IMI, mais-valias imobiliárias ou salário líquido. Em que posso ajudar?",
};
